...
internal static partial class TestSuite
{
    ...
    [
        ...
        new("Default input reactive mode is disabled", DefaultInputReactiveModeIsDisabled),
        ...
        new("Settings round trip includes input reactive mode", SettingsRoundTripIncludesInputReactiveMode),
