...
internal static partial class TestSuite
{
    internal static IReadOnlyList<(string Name, Action Test)> Tests { get; } = new (string Name, Action Test)[]
    {
        ...
        ("Production code is organized by architecture", ProductionCodeIsOrganizedByArchitecture),
        ("Architecture dependencies point inward", ArchitectureDependenciesPointInward),
        ...
        ("Menu commands preserve behavior through application boundaries", MenuCommandsPreserveBehaviorThroughApplicationBoundaries),
